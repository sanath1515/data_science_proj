...
def get_jobs(keyword, num_jobs, verbose, path, sleepTime):
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        try:
            # driver.find_element(By.XPATH,'//*[@id="LoginModal"]/div/div/div/div[2]/button')
        ...
        for job_button in job_buttons:  
            ...
            try:
                salary_estimate = driver.find_element(By.XPATH,'.//div[@id="JDCol"]/div/article/div/div[2]/div[1]/div[2]/div/div/div[2]/div[1]').text
            except NoSuchElementException:
